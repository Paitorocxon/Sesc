...
class writer{
    function edit($file){
        ...
        if (isset($_REQUEST['typeof']) && $_REQUEST['typeof'] == 'Normal'){
            ...
            if (file_exists($file)){
                return '
                <button onclick="striping()" id="menuitem">Aa</button>
                ...
                return '<form method="POST"><br><input type="submit" value="' . $GLOBALS['LangSave'] . '"><input type="hidden" name="m" id="m" value="' . $file . '"           > 
